...
const Hero = ({ scrollYProgress }) => {
  const scale = useTransform(scrollYProgress, [0, 2], [1, 0.8]);
  const rotate = useTransform(scrollYProgress, [0, 1], [0, -5]);

  return (
    <motion.section
      style={{ scale, rotate }}
      className="bg-linear-45 from-blue-700 to-indigo-950 sticky top-0 h-screen grid place-items-center"
    >
      <div className="container max-w-7xl mx-auto w-full h-screen flex flex-row justify-center items-center">
